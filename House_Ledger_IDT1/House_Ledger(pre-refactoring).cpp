...
public:
	Account(string n, string pswd, House h);
...
Account::Account(string n, string pswd, House h) : name(name), house(h) {
...
Account void_account("void", "default", void_house);
House void_house("void", "default", vector<Account>{});
